...
monster.attacks = {
	{ name = "melee", interval = 2500, chance = 100, minDamage = 0, maxDamage = -1200 },
	{ name = "combat", interval = 2500, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -1100, maxDamage = -1550, length = 8, spread = 3, effect = CONST_ME_ELECTRICALSPARK, target = false },
	{ name = "combat", interval = 2500, chance = 15, type = COMBAT_HOLYDAMAGE, minDamage = -1100, maxDamage = -1700, radius = 5, effect = CONST_ME_GHOSTLY_BITE, target = false },
	{ name = "combat", interval = 2500, chance = 10, type = COMBAT_ENERGYDAMAGE, minDamage = -1100, maxDamage = -1500, radius = 5, effect = CONST_ME_ELECTRICALSPARK, target = false },
	{ name = "extended holy chain", interval = 2000, chance = 15, minDamage = -1100, maxDamage = -1700, range = 3 },
	{ name = "largepinkring", interval = 2500, chance = 10, minDamage = -1100, maxDamage = -1800, target = false },
	{ name = "agonyfield", interval = 2000, chance = 10, range = 7, radius = 2, shootEffect = CONST_ANI_POISON, target = true },
}
...
monster.attacks = {
	...
	{ name = "extended holy chain", interval = 2000, chance = 15, minDamage = -1100, maxDamage = -1700 },
