...
monster.attacks = {
	...
	{ name = "combat", interval = 2600, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -1100, maxDamage = -1750, length = 8, spread = 3, effect = CONST_ME_HITBYFIRE, target = false },
	{ name = "combat", interval = 3100, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -1100, maxDamage = -1700, length = 8, spread = 3, effect = CONST_ME_HOLYAREA, target = false },
	...
	{ name = "largefirering", interval = 2000, chance = 10, minDamage = -800, maxDamage = -1900, target = false },
}
