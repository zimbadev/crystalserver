...
monster.attacks = {
	...
	{ name = "chagorzring", interval = 2000, chance = 25, minDamage = -1200, maxDamage = -2000, target = false },
	...
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_DEATHDAMAGE, minDamage = -600, maxDamage = -1000, length = 8, spread = 0, effect = 221, target = false },
