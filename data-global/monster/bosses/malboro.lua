local mType = Game.createMonsterType("Malboro")
local monster = {}

monster.description = "Malboro"
...
monster.summon = {
	maxSummons = 1,
	summons = {
		{ name = "Malboro Tentacle", chance = 20, interval = 2000, count = 4 },
	},
}
...
monster.loot = {
	...
	{ name = "bag you desire", chance = 20000, unique = true },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 32, type = COMBAT_PHYSICALDAMAGE, minDamage = -800, maxDamage = -1600, radius = 8, effect = CONST_ME_CARNIPHILA, target = false },
	{ name = "combat", interval = 2000, chance = 19, type = COMBAT_EARTHDAMAGE, minDamage = -1200, maxDamage = -2800, range = 7, radius = 3, shootEffect = CONST_ANI_POISON, effect = CONST_ME_CARNIPHILA, target = true },
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_PHYSICALDAMAGE, minDamage = -2000, maxDamage = -4000, length = 7, spread = 0, effect = CONST_ME_GROUNDSHAKER, target = false },
	{ name = "speed", interval = 8000, speedChange = -9999, range = 7, effect = CONST_ME_MAGIC_RED, target = false, duration = 20000 },
...
monster.defenses = {
	...
	armor = 100,
	--	mitigation = ???,
	{ name = "combat", interval = 2000, chance = 25, type = COMBAT_HEALING, minDamage = 1500, maxDamage = 2500, effect = CONST_ME_MAGIC_BLUE, target = false },
}
