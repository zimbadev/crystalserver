...
monster.loot = {
	{ name = "crystal coin", chance = 28938, maxCount = 400 },
	{ name = "ultimate mana potion", chance = 21433, maxCount = 198 },
	{ name = "giant amethyst", chance = 20570, maxCount = 10 },
	{ name = "giant topaz", chance = 20570, maxCount = 10 },
	{ name = "ultimate spirit potion", chance = 21433, maxCount = 45 },
	{ name = "giant ruby", chance = 20570, maxCount = 10 },
	{ name = "giant sapphire", chance = 20570, maxCount = 10 },
	{ name = "mastermind potion", chance = 20938, maxCount = 23 },
	...
	{ name = "Fiery Tear", chance = 25000, maxCount = 1 },
	{ name = "violet gem", chance = 20970, maxCount = 25 },
	{ name = "yellow gem", chance = 20970, maxCount = 25 },
	{ name = "figurine of bakragore", chance = 20970 },
	{ name = "bakragore's amalgamation", chance = 15570 },
	{ name = "spiritual horseshoe", chance = 15470 },
	{ id = 51588, chance = 18000, maxCount = 5 }, -- proficiency catalyst
	{ id = 51589, chance = 18000, maxCount = 2 }, -- greater proficiency catalyst
	{ id = 43946, chance = 10000, maxCount = 1 }, -- scroll 1
	{ id = 43947, chance = 7000, maxCount = 1 }, -- scroll 2
	{ id = 43948, chance = 6000, maxCount = 1 }, -- scroll 3
	{ id = 43949, chance = 5000, maxCount = 1 }, -- scroll 4
	{ id = 43950, chance = 1000, maxCount = 1 }, -- scroll 5
	{ id = 52851, chance = 10000 }, -- vip experience scroll (+50% exp)
	{ id = 43895, chance = 500 }, ---bag you covet
	{ id = 43860, chance = 1 }, ---bag you covet (grand sanguine)
}

--{id = 43946, minCount = 1, maxCount = 1, chance = 0.5},--scroll 1
--{id = 43947, minCount = 1, maxCount = 1, chance = 0.5},--scroll 2
--{id = 43948, minCount = 1, maxCount = 1, chance = 0.5},--scroll 3
--{id = 43949, minCount = 1, maxCount = 1, chance = 0.5},--scroll 4
--{id = 43950, minCount = 1, maxCount = 1, chance = 0.5},--scroll 5
