...
monster.attacks = {
	{ name = "combat", interval = 2000, chance = 100, type = COMBAT_FIREDAMAGE, minDamage = -400, maxDamage = -800, radius = 4, effect = CONST_ME_FIREATTACK, target = false }, -- não confirmado
}
