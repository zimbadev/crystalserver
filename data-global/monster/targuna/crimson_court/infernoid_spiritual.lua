local mType = Game.createMonsterType("Infernoid Spiritual")
local monster = {}

monster.description = "an infernoid spiritual"
...
monster.health = 102
monster.maxHealth = 102
monster.race = "fire"
monster.corpse = 53128 -- corpse Targuna (appearances.dat)
monster.speed = 92
monster.manaCost = 0
...
monster.loot = {
	...
	{ id = 3449, chance = 50000, maxCount = 5 }, -- burst arrow
