...
local function creatureSayCallback(npc, creature, type, message)
    ...
    if MsgContains(message, "key") then
        if player:getStorageValue(Storage.Quest.U14_10.AzzilonCastle.ForgemasterDoor.Questline) == 2 then
            player:setStorageValue(Storage.Quest.U14_10.AzzilonCastle.ForgeMaster.AccessDoor, 1)
            player:setStorageValue(Storage.Quest.U14_10.AzzilonCastle.ForgemasterDoor.Questline, 3)
