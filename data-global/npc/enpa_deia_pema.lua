...
local function hasAllShrines(player)
    ...
    return kv:get("guidance") and kv:get("tranquility") and kv:get("respect") and kv:get("legacy") and
           kv:get("empathy") and kv:get("harmony") and kv:get("power") and kv:get("knowledge") and
           kv:get("serenity") and kv:get("eternity")
end
