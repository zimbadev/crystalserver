...
local function hasDawnportShrines(player)
        return player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Shrines.FirstShrine) == 1 and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Shrines.SecondShrine) == 1 and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Shrines.ThirdShrine) == 1 and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Shrines.FourthShrine) == 1
end

local function hasAllShrines(player)
        return player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Guidance) == 1
                and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Tranquility) == 1
                and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Respect) == 1
                and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Legacy) == 1
                and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Empathy) == 1
                and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Harmony) == 1
                and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Power) == 1
                and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Knowledge) == 1
                and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Serenity) == 1
                and player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.MainShrines.Eternity) == 1
end
...
local function creatureSayCallback(npc, creature, type, message)
        ...
        if MsgContains(message, "pilgrimage") then
                if MsgContains(message, "pilgrimage") then
                        if hasDawnportShrines(player) then
                                if player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Questline) == 2 then
                                ...
                                npcHandler:say("You must first visit the sacred shrines in Dawnport.", npc, creature)
                                return true
                        end

                        if hasAllShrines(player) then
                                if player:getStorageValue(Storage.Quest.U15_00.TheWayOfTheMonk.Questline) == 3 then
