local internalNpcName = "Raubritter Post"
local npcType = Game.createNpcType(internalNpcName)
local npcConfig = {}

npcConfig.name = internalNpcName
npcConfig.description = "a raubritter post"
...
local function greetCallback(npc, creature)
	...
	npcHandler:say("This area is restricted!", npc, creature) -- TODO: Confirmar diálogo
