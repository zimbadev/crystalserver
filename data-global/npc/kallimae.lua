...
local function creatureSayCallback(npc, creature, type, message)
	...
	elseif MsgContains(message, "yes") and npcHandler:getTopic(playerId) == 1 then
		if player:getStorageValue(Storage.Kilmaresh.Sixth.Favor) == 11 then
			...
			player:setStorageValue(Storage.Quest.U12_20.Kilmaresh.Eighth.Yonan, 1)
			player:setStorageValue(Storage.Quest.U12_20.Kilmaresh.Eighth.Narsai, 1)
			player:setStorageValue(Storage.Quest.U12_20.Kilmaresh.Eighth.Shimun, 1)
			player:setStorageValue(Storage.Quest.U12_20.Kilmaresh.Eighth.Tefrit, 1)
