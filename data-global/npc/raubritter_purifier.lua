local internalNpcName = "Raubritter Purifier"
...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Purity through fire!" }, -- TODO: Confirmar texto
	{ text = "The unworthy shall burn!" }, -- TODO: Confirmar texto
}
...
local function greetCallback(npc, creature)
	...
	npcHandler:say("Your impurity offends me. Begone!", npc, creature) -- TODO: Confirmar diálogo
