local internalNpcName = "Raubritter Guard"
...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Halt! Who goes there?" }, -- TODO: Confirmar texto
	{ text = "This area is restricted!" }, -- TODO: Confirmar texto
}
...
local function greetCallback(npc, creature)
	...
	npcHandler:say("You are not welcome here. Leave immediately!", npc, creature) -- TODO: Confirmar diálogo
