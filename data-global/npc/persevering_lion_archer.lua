local internalNpcName = "Persevering Lion Archer"
local npcType = Game.createNpcType(internalNpcName)
local npcConfig = {}

npcConfig.name = internalNpcName
npcConfig.description = "a persevering lion archer"
...
npcHandler:setMessage(MESSAGE_GREET, "We hold on. No matter how dire the situation, we persevere for the Order.") -- TODO: Confirmar
npcHandler:setMessage(MESSAGE_FAREWELL, "For the Order!") -- TODO: Confirmar
