local internalNpcName = "Weary Lion Knight"
local npcType = Game.createNpcType(internalNpcName)
local npcConfig = {}

npcConfig.name = internalNpcName
npcConfig.description = "a weary lion knight"
...
npcHandler:setMessage(MESSAGE_GREET, "We fought bravely, but they were too many. I fear I cannot fight much longer...") -- TODO: Confirmar
