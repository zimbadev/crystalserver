...
keywordHandler:addKeyword({ "blood crystal" }, StdModule.say, { npcHandler = npcHandler, text = "If I had one, I could charge a fortune for it... <gets a dreamy look>" }, function(player)
