local internalNpcName = "Raubritter Guardsman"
...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Keep moving, citizen." }, -- TODO: Confirmar texto
	{ text = "No trespassing!" }, -- TODO: Confirmar texto
}
...
local function greetCallback(npc, creature)
	...
	npcHandler:say("Move along! There's nothing for you here!", npc, creature) -- TODO: Confirmar diálogo
