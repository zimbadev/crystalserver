...
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, text = "G'Ezkho." })
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, text = "I trade in what the wastes cough up. Moonsilver, mostly, when the moonspawns let me near it." })
