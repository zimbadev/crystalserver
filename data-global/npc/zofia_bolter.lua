local internalNpcName = "Zofia Bolter"
...
keywordHandler:addKeyword({ "name" }, StdModule.say, { npcHandler = npcHandler, text = "Zofia Bolter." })
keywordHandler:addKeyword({ "job" }, StdModule.say, { npcHandler = npcHandler, text = "I hunt moonspawns. It pays badly and I am very good at it." })
