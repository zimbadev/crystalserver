...
keywordHandler:addKeyword({ "sleigh" }, StdModule.say, { npcHandler = npcHandler, text = "Oh, the sleigh is magical, of course. It was made by some djinn that owed good old Santa a favour." })
keywordHandler:addKeyword({ "stolen" }, StdModule.say, { npcHandler = npcHandler, text = "The goblins of clan Grynch have made it a habit to steal presents in the cities and even from Santa's sleigh. If you should find any, please return them to me and I will reward you with a token. You can collect tokens and trade them for a nice gift." })
