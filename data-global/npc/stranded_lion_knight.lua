local internalNpcName = "Stranded Lion Knight"
local npcType = Game.createNpcType(internalNpcName)
local npcConfig = {}

npcConfig.name = internalNpcName
npcConfig.description = "a stranded lion knight"
...
npcHandler:setMessage(MESSAGE_GREET, "We've been stranded here since the warlock attacked. We cannot leave without help.") -- TODO: Confirmar
