local internalNpcName = "Raubritter Sentry"
...
npcConfig.voices = {
	interval = 15000,
	chance = 50,
	{ text = "Halt!" }, -- TODO: Confirmar texto
	{ text = "Who goes there?" }, -- TODO: Confirmar texto
}
...
local function greetCallback(npc, creature)
	...
	npcHandler:say("This is a restricted area. Turn back now!", npc, creature) -- TODO: Confirmar diálogo
