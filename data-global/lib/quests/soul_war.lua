SoulWarQuest = {
	...
	ebbAndFlow = {
		...
		mapsPath = {
			empty = "data-global/world/quest/soul_war/ebb_and_flow/ebb-flow-empty.otbm",
			inundate = "data-global/world/quest/soul_war/ebb_and_flow/ebb-flow-inundate.otbm",
			ebbFlow = "data-global/world/quest/soul_war/ebb_and_flow/ebb-flow.otbm",
		},
