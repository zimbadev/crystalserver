local tentacle10_death = CreatureEvent("tentacle10_death")
...
function tentacle10_death.onDeath(creature, corpse, killer, mostDamage, unjustified, mostDamage_unjustified)
