local tentacle7_death = CreatureEvent("tentacle7_death")
...
local config = {
	...
	monsterName = "Tentacle7",

	finalTile = {
		triggerPos = Position(33726, 31177, 6),
		itemPos = Position(33726, 31176, 6),
		fromId = 35510,
		toId = 35107,
	},
}
...
function tentacle7_death.onDeath(creature, corpse, killer, mostDamage, unjustified, mostDamage_unjustified)
