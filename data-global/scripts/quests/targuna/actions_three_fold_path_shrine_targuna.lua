...
function actions_three_fold_path_shrine_targuna.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	...
	player:sendTextMessage(
		...
		"The Three-Fold Path dictates the order of the shrines to visit and when to do this. This is either not the time for this shrine or you are not yet experienced enough to prepare yourself for the gifts of the Merudri."
	)
	return true
end
