...
static constexpr auto SOFTWARE_NAME = "KosOTS";
static constexpr auto SOFTWARE_VERSION = "1.0.0";
static constexpr auto SOFTWARE_DEVELOPERS = "M@J3M";
...
static constexpr auto CLIENT_VERSION = 1503;
