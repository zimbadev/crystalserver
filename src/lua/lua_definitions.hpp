...
enum CreatureEventType_t : uint8_t {
	...
	CREATURE_EVENT_KOSTASK_PROGRESS,
	CREATURE_EVENT_KOSTASK_COMPLETE,
	CREATURE_EVENT_KOSTASK_COMPLETED,
};
...
enum ErrorCode_t {
	...
	LUA_ERROR_KOSTASK_NOT_FOUND,
	LUA_ERROR_KOSTASK_INVALID_STAGE,
};
