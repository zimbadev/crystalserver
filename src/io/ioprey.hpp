...
inline const std::unique_ptr<PreySlot> PreySlotNull {};
inline const std::unique_ptr<TaskHuntingSlot> TaskHuntingSlotNull {};
inline const std::unique_ptr<TaskHuntingOption> TaskHuntingOptionNull {};
