...
bool Map::placeCreature(const Position &centerPos, const std::shared_ptr<Creature> &creature, bool extendedPos /* = false*/, bool forceLogin /* = false*/, const std::shared_ptr<Tile> &centerTile /* = nullptr */) {
