...
enum Banner_t : uint8_t {
	...
	BANNER_TYPE_DEATHPVE = 2, // deprecated, triggers by death message now
	BANNER_TYPE_DEATHPVP = 3, // deprecated, triggers by death message now
	...
	// popups that only show to no vocation characters
