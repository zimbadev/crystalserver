...
function inquisitionRewards.onUse(player, item, fromPosition, target, toPosition, isHotkey)
	if player:getStorageValue(Storage.Quest.U8_0.TheInquisitionQuest.Reward) < 1 then
		player:setStorageValue(Storage.Quest.U8_0.TheInquisitionQuest.Reward, 1)
		player:setStorageValue(Storage.Quest.U8_0.TheInquisitionQuest.Questline, 25)
		player:setStorageValue(Storage.Quest.U8_0.TheInquisitionQuest.Mission07, 5) -- The Inquisition Questlog- "Mission 7: The Shadow Nexus"
