...
function playerDeath.onDeath(player, corpse, killer, mostDamageKiller, unjustified, mostDamageUnjustified)
	...
	-- Remove ALL icons when player dies (including Rotten Blood icons)
	local function removeAllPlayerIcons(player)
		local iconMap = {
			"whitecross", "redcross", "redball", "greenball", "redgreenball",
			"greenshield", "yellowshield", "blueshield", "purpleshield", "redshield",
			"dove", "energy", "earth", "water", "fire", "ice", "arrowup", "arrowdown",
			"exclamationmark", "questionmark", "cancelmark", "hazard", "brownskull",
			"higherdamagereceived", "lowerdamagedealt", "turnedmelee", "influenced",
			"fiendish", "reducedhealth", "reducedhealthexclamation",
			"rotten-area", "rotten-hazard", "white-cross",
		}
